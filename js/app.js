...
var lights = () => {
    ...
    if (timeDiff <= 0) {
        ...
        document.querySelector('.lights-countdown').innerHTML = '<div class="twelve columuns centered-text"><h3>The lights are on!</h3></div><div class="twelve columuns centered-text"><h3>The show starts at 5:30 PM and ends at 11 :00 PM. Monday thru Sunday</h3></div>';
